...
import { FacebookIcon, GithubIcon, InstagramIcon, LinkedInIcon, MoonIcon, SunIcon } from './Icons'
...
return (
    ...
    <motion.a href="https://www.facebook.com/kikejoabf/?locale=es_ES" target= {"_blank"}
    className='w-6 mr-3
    whileHover={{y:-2}}
    whileTap={{scale:0.9}}
    '>
    ...
    <motion.a href="https://www.instagram.com/ejoab1995/?hl=es-la" target= {"_blank"}
    className='w-6 mx-3'
    whileHover={{y:-2}}
    whileTap={{scale:0.9}}>
        <InstagramIcon/>
    ...
    <motion.a href="https://github.com/EJoabFlores" target= {"_blank"}
    className='w-6 mx-3'
    whileHover={{y:-2}}
    whileTap={{scale:0.9}}> 
        <GithubIcon/>
    ...
    <motion.a href="https://www.linkedin.com/in/enrique-joab-flores-gonzález-7b441725a/" target= {"_blank"}
    className='w-6 ml-3'
    whileHover={{y:-2}}
    whileTap={{scale:0.9}}>
        <LinkedInIcon/>
...

{
    ...
    className='min-w-[70vw] flex flex-col z-30 justify-between items-center fixed top-1/2
left-1/2 -traslate-x-1/2 -traslate-y-1/2 bg-dark/90  dark:bg-light/75  rounded-lg backdrop-blur-md py-32'>
